...
const AboutPage = () => {
  return (
    <div className="flex flex-col lg:gap-y-10 gap-y-6 justify-center items-center w-full min-h-screen lg:text-xl text-lg font-medium capitalize text-center font-agrandir">
      <h4 className="w-[80%] mt-16">
        ...
        subtle strokes. I am not an introvert, but an antisocial extrovert who
        dances to his own rhythm, steering clear of shallow tides.
      </h4>
      <h4 className="w-[80%]">
